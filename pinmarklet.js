    ...
    UTIL.pinterest = (function () {
        var pinmarkletConfig = {
            ...
            rules : [
                ...
                "#_hd { z-index:2147483643; -moz-box-shadow: 0 1px 2px #aaa; -webkit-box-shadow: 0 1px 2px #aaa; box-shadow: 0 1px 2px #aaa; position: fixed; *position:absolute; width:100%; top: 0; left: 0; right: 0; height: 45px; line-height: 45px; font-size: 14px; font-weight: bold; display: block; margin: 0; background: #fff; border-bottom: 1px solid #aaa; }",
                "#_hd #_logo {height: 43px; width: 100px; display: inline-block;background: transparent url(images/flickrWhite.png) 50% 50% no-repeat; border: none;}",

                "#_hd a#_x { display: inline-block; cursor: pointer; color: #524D4D; line-height: 45px; text-shadow: 0 1px #fff; float: right; text-align: center; width: 100px; border-left: 1px solid #aaa; display:none; }",
                ...
                "#_bd span._pinButton {z-index: 2; height: 200px; width: 200px; background: transparent url(images/flickit.png) 50% 50% no-repeat; position:absolute; top:0; left:0; display:none; }",
